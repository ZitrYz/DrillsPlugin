...
public class GroundDrill extends DrillItem {
	
	public GroundDrill(ItemStack drillItemStack) {
		...
		if (drillItemStack != null) {
			...
			this.drillItem = createDrillItem("§dGround Drill", this.maxFuel, drillType.GROUND_DRILL);
